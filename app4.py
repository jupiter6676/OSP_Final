...
def box():
	...
	# mytime2 = time.time() - start
	# mytime2 = round(mytime2, 3)
	...
	# mytime3 = time.time() - start
	# mytime3 = round(mytime3, 3)
	...
	# mytime4 = time.time() - start
	# mytime4 = round(mytime4, 3)
	...
	# mytimec = time.time() - start
	# mytimec = round(mytimec, 3)
	...
	# mytimet = time.time() - start
	# mytimet = round(mytimet, 3)
	...
	return render_template('page.html', 
		wa="https://nutch.apache.org/",	status=success, cnt=cnt, time=mytime)
...
@app.route('/cos')
def cos():
	return render_template('simi.html', url1="http://attic.apache.org/", url2="https://brooklyn.apache.org/", url3="https://allura.apache.org/",
	sim1=cosSimil_1, sim2=cosSimil_2, sim3=cosSimil_3)
